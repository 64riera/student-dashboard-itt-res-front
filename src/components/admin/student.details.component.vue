  ...
  <v-container>
    <v-row>
      <v-col cols="12" xs="12" sm="12" md="12" lg="6" xl="6" class="justify-content">
        <template>
          <v-card class="mx-auto" max-width="434" raised>
        ...
        <v-form class="mt-6">
            <v-text-field outlined readonly label="Edad" v-model="studentData.age">
            </v-text-field>
            <v-text-field outlined readonly label="# de control" v-model="studentData.controlNum">

            </v-text-field>
            <v-text-field outlined readonly label="Email" v-model="studentData.email">
            ...
            <v-text-field outlined readonly label="Fecha de registro"
                          v-model="studentData.createdAt">
                    ...
                    <v-col cols="12" xs="12" sm="12" md="12" xl="12">
                      <v-card class="text-center pa-1 mt-4 animated fadeIn" outlined>
                        ...
                        <v-card-text>
                          ...
                          >
                          <p class="mt-4"></p>
                          <v-btn dark depressed rounded small color="red accent-3"
                            >Completado</v-btn
                          >
                        </v-card-text>
                      </v-card>
...
export default {
  ...
  created() {
    this.getStudentData();
    this.verifyStateOfSteps();
  },
  methods: {
    async getStudentData() {
      const { controlNum } = this.$route.params;
      this.$store.dispatch('usersModule/getUserData', controlNum);
    },
    verifyStateOfSteps() {
